...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M3.964 10.71c-.18-.54-.2822-1.1168-.2822-1.71s.1023-1.17.2823-1.71V4.9582H.9573C.3477 6.1731 0 7.5477 0 9s.3477 2.8268.9573 4.0418L3.964 10.71z" fill="#FBBC05"/>
    <path d="M9 3.5795c1.3214 0 2.5077.4541 3.4405 1.346l2.5813-2.5814C13.4627.8918 11.4254 0 9 0 5.4818 0 2.4382 2.0168.9573 4.9582L3.964 7.29C4.6718 5.1632 6.656 3.5795 9 3.5795z" fill="#EA4335"/>
  </svg>
);
...
const OrDivider = ({ label = "or Login with Email" }) => (
  <div className="flex items-center gap-3 my-1">
    ...
    <span className="text-xs text-subtle font-sans whitespace-nowrap">{label}</span>
    <hr className="divider flex-1 m-0" />
  </div>
);
      ...
      <div className="w-full max-w-[360px] flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <RememberMe checked={remember} onChange={() => setRemember((r) => !r)} />
            <a href="#" className="text-sm text-accent font-sans font-medium no-underline transition-fast hover:text-[var(--color-accent-hover)]">
              Forgot Password?
            </a>
          </div>
          ...
          {/* Error */}
          {error && (
            <p className="text-xs font-sans m-0 px-3 py-2 rounded-sm border"
               style={{ color: "#c0392b", background: "#fdf0ed", borderColor: "#f5c6c0" }}>
              {error}
            </p>
          )}
